...
import JSDOM.EventM (EventM, on)
import JSDOM.Window (Window, getLocalStorage, getSessionStorage)
import JSDOM.WindowEventHandlers (storage)
import JSDOM.Storage (Storage(..), getItem, setItem, removeItem)
import JSDOM.StorageEvent
