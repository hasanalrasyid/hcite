...
messagesProtoFile = toProtoFile msgStripPrefixOptions $ packageFromDefs "hciteservice"
...
whoisProtoFile = toProtoFile msgStripPrefixOptions $ packageFromDefs "hciteservice"
